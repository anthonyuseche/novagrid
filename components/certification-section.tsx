    ...
    <section className="py-16 relative overflow-hidden section-transition" ref={ref}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800 dark:text-white">
            Certificación <span className="text-gradient">EF SET C2</span>
          </h2>
          <p className="text-gray-600 dark:text-white/70 mb-6">
            Certificado oficial que acredita mi dominio del inglés a nivel profesional (C2), facilitando la comunicación
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="bg-white/95 dark:bg-[#0A192F]/95 backdrop-blur-xl border border-gray-100 dark:border-white/10 text-gray-800 dark:text-white max-w-3xl">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-gradient">Certificado EF SET C2 Proficient</DialogTitle>
          </DialogHeader>
          <div className="relative h-96 my-4 rounded-lg overflow-hidden">
            <Image
              src="/placeholder.svg?height=800&width=600"
              alt="EF SET C2 Certificate"
              fill
          ...
          <div className="mt-4 flex justify-between">
            <p className="text-white/70">
              Certificado que acredita nivel C2 (Proficient) en inglés según el Marco Común Europeo de Referencia para
              las lenguas.
            </p>
            <Button
              variant="outline"
